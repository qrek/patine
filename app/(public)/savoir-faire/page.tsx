...
export default async function SavoirFairePage() {
  ...
  return (
    <div>
      ...
      <section className="min-h-screen grid grid-cols-1 lg:grid-cols-2">
        ...
        <div className="flex flex-col justify-between px-8 lg:px-16 pt-32 pb-14 bg-cream">
          <div>
            ...
            <h1 className="font-power text-5xl md:text-6xl lg:text-7xl text-noir leading-[1.05]">
              {pageTitle}
            </h1>
          </div>
          {sections[0]?.body && (
            <div
              className="text-[15px] leading-relaxed text-noir-soft max-w-[480px] mt-auto pt-16 rich-text"
        ...
        <div className="relative h-[60vh] lg:h-auto bg-[#D8D6D1] overflow-hidden">
          {heroImage ? (
            <Image src={heroImage} alt="Savoir-faire Patine" fill className="object-cover" priority />
          ) : (
      ...
      {/* ── Sections de texte (à partir de la 2e) ── */}
        ...
        <article key={section.id} className="border-t border-border">
          <div className="max-w-wide mx-auto px-8 lg:px-16 py-16 md:py-20">
            <div className="grid md:grid-cols-[160px_1fr] gap-10">
              <div />
              <div>
                <h2 className="font-power text-3xl md:text-4xl text-noir mb-6">
                  {section.title}
                </h2>
                <div
                  className="text-[15px] leading-relaxed text-noir-soft max-w-[560px] rich-text"
